    ...
    Vue.prototype.$util = {
      ...
      canvasParticle(cfg) {
        ...
        function canvasInit(canvasConfig) {
          ...
          // 获取特定div作为背景
          // canvasParticle是你想要将其作为背景的div的ID
          var body = document.getElementById("canvasParticle");
          ...
          canvas.element.style["z-index"] = "-1";
        ...
        function canvasSize(canvas) {
          ...
          // 获取特定div的宽高
          var dom =  document.getElementById("canvasParticle");
          var width = dom ? dom.style.width : 0;
          var height = dom ? dom.style.height : 0;
